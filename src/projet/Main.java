...
public class Main {
	...
	/*
	 * cette méthode vérifie si ce qui a été saisi est bien un entier sinon lève une
	 * exception et demande à l'utilisateur de resaisir un entier
	 */
	...
	/*
	 * cette méthode vérifie si ce qui a été saisi est bien un String sinon lève une
	 * exception et demande à l'utilisateur de resaisir une chaine de caractère
	 */
			...
			try {
				...
				if (!res.matches("[a-zA-Z]+")) {
					throw new InputMismatchException(
							"Il faut taper une chaine de caractère contenant le nom de la ville");
				}
				lectureValide = true;
			} catch (InputMismatchException e) {
